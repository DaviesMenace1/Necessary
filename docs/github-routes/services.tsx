...
function ServicesPage() {
  const { images } = usePageContent("services");
  const fallbacks = [process1, process2, process1, process2, process1, process2];
  const gallery = images("gallery", fallbacks);
  return (
    <>
            ...
            >
              <div className="lg:col-span-5">
                <div className="aspect-[4/5] overflow-hidden rounded-md bg-muted">
                  <img
                    src={gallery[i % gallery.length] ?? (i % 2 ? process2 : process1)}
                    alt=""
                    aria-hidden
                    loading="lazy"
